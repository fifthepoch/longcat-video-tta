...
| **Opening spread match** | `sweep_experiment/reports/paper_tables/2026-09-20_opening_spread_match.md` | Two-sided: stay in support (no takeover) and match scale (no photo-still / twitch). Degenerate if opening is still. |
