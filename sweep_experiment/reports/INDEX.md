...
| `wan_teacher_pwarp_amp_smoke` | Leftover n=2. A ramp / B persist / C s2-8 / D early / E mag + lives. Official teacher. | **IN-FLIGHT.** Generate 17172470–482 COMPLETED 0:0. VBench **17172483** RUNNING. Cite `wan_notta`. Do not letter n=2. Do not launch 128. | Spec: [`2026-09-07_pwarp_amp_spec.md`](paper_tables/2026-09-07_pwarp_amp_spec.md). |
