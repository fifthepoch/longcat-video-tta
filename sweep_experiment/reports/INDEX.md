...
| Coincidence first-8 spec | MovieGen T2V 30 s. `notta` / window / coinc / writeevery / titans / meandelta. | **PROTOCOL FAIL.** Titans 18234331 FAILED 2:0 (η broadcast). VBench 333 cancelled. Five generate arms 8/8. Do not letter n=2. Do not launch 128. | [`2026-09-21_t2v_coinc8_spec.md`](paper_tables/2026-09-21_t2v_coinc8_spec.md). Harvest: [`2026-09-22_t2v_coinc8_harvest.md`](paper_tables/2026-09-22_t2v_coinc8_harvest.md). |
| `t2v_moviegen_coinc_8v` | Six arms above. MovieGen first-8, 30 s. | **PROTOCOL FAIL.** notta 327 / window 328 / coinc 329 / writeevery 330 / meandelta 332 COMPLETED 0:0. titans 331 FAILED 2:0. VBench 333 CANCELLED. Resubmit titans + VBench only. | Spec: [`2026-09-21_t2v_coinc8_spec.md`](paper_tables/2026-09-21_t2v_coinc8_spec.md). Harvest: [`2026-09-22_t2v_coinc8_harvest.md`](paper_tables/2026-09-22_t2v_coinc8_harvest.md). `submit_t2v_coinc8_titans_fix.sh`. Do not letter n=2. Do not launch 128. |
