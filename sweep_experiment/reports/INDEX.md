...
| `v2v_panda_caption_wanext_8v_smoke` | `notta` on Wan-extended first-2 leftovers. | **17093254–256 left `squeue` immediately.** Prepare / generate / VBench. Harvest pending `sacct`. Do not resubmit yet. | [`experiment_outputs/2026-09-07.md`](experiment_outputs/2026-09-07.md). |
