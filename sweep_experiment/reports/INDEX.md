...
| `wan_teacher_leftover_smoke` | `wan_notta` / always / gated / nwarp / nwarp_live / pwarp / pwarp_live. Leftover Panda n=2. Official teacher, no `self_forcing_dmd.pt`. | **IN-FLIGHT 17135846–853** (SDPA). First wave **FAILED 2:0 17132796–802** FA2 assert. | Harvest after COMPLETED 0:0. Log should print SDPA warn. |
| `wan_teacher_moviegen_smoke` | Same 7 methods. MovieGen n=2. Official teacher, 81 frames. | **IN-FLIGHT 17135854–861** (SDPA). First wave **FAILED 2:0 17132804–810**. | Do not letter n=2. Do not launch 128. |
