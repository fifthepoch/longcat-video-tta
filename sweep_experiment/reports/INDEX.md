...
| `v2v_panda_caption_wanext_8v_smoke` | `notta` on Wan-extended first-2 leftovers. | **17093254–256 COMPLETED 0:0.** Prepare 2m11 (Qwen wrote dest). Generate 32m. VBench 4m. Harvest pending full texts + VBench. Do not letter n=2. | [`experiment_outputs/2026-09-07.md`](experiment_outputs/2026-09-07.md). |
