...
| `t2v_moviegen_coinc_8v` | Six arms above. MovieGen first-8, 30 s. | **PROTOCOL FAIL.** Five generate 8/8. titans 331 crashed; rerun 18257632 + VBench 18257633 afterok. Write tape C≈0.91, coinc=meandelta 8 seed + 40 fork. No VBench yet. | Spec: [`2026-09-21_t2v_coinc8_spec.md`](paper_tables/2026-09-21_t2v_coinc8_spec.md). Harvest: [`2026-09-22_t2v_coinc8_harvest.md`](paper_tables/2026-09-22_t2v_coinc8_harvest.md). Do not letter n=2. Do not launch 128. |
