...
| Coincidence first-8 spec | MovieGen T2V 30 s. `notta` / window / coinc / writeevery / titans / meandelta. | **IN FLIGHT 18234327–333.** Real DeltaNet hook, not the pprot legal bank. Do not letter n=2. Do not launch 128. | [`2026-09-21_t2v_coinc8_spec.md`](paper_tables/2026-09-21_t2v_coinc8_spec.md). |
| `t2v_moviegen_coinc_8v` | Six arms above. MovieGen first-8, 30 s. | **IN FLIGHT 18234327–333.** notta 327 / window 328 / coinc 329 / writeevery 330 / titans 331 / meandelta 332. VBench 333 afterok. All PD (Priority / Dependency) at submit. | Spec: [`2026-09-21_t2v_coinc8_spec.md`](paper_tables/2026-09-21_t2v_coinc8_spec.md). Harvest: `wan_experiment/scripts/harvest_t2v_coinc.py`. Do not letter n=2. Do not launch 128. |
