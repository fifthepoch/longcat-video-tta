...
| `wan_teacher_pwarp_amp_smoke` | Leftover n=2. A ramp / B persist / C s2-8 / D early / E mag + lives. Official teacher. | **SUBMIT-READY.** Cite `wan_notta`. Do not letter n=2. Do not launch 128. | Spec: [`2026-09-07_pwarp_amp_spec.md`](paper_tables/2026-09-07_pwarp_amp_spec.md). |
