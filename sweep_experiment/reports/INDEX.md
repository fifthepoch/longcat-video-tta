...
| Why DMD / frozen-noise literature | DMD papers write train=infer, not a ban on warping a frozen Wan. No GPU. | Our IQ drop is the measurement. GwF still fine-tunes video warp. FIFO on frozen SF/RF was NO. | [`2026-09-08_why_dmd_frozen_noise.md`](paper_tables/2026-09-08_why_dmd_frozen_noise.md). |
| Idea 2 occupied (Rolling sink) | Trained leftover sink vs Rolling first-chunk sink. No GPU. | Same idea: opening has the good information. Source of opening is protocol. **OCCUPIED** as a title. Leftover-as-sink = Rolling ablation only. Do not launch 8-GPU. | [`2026-09-08_idea2_occupied_rolling.md`](paper_tables/2026-09-08_idea2_occupied_rolling.md). |
| PI summer briefing | Parameter-space exit + Wan cite-128 search table. Talk notes. No GPU. | Notes only. Canvas not in repo. | [`2026-09-08_pi_summer_briefing.md`](paper_tables/2026-09-08_pi_summer_briefing.md). |
