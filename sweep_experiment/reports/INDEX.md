...
| Coincidence first-8 spec | MovieGen T2V 30 s. `notta` / window / coinc / writeevery / titans / meandelta. | **SUBMIT-READY, not launched.** Real DeltaNet hook, not the pprot legal bank. Do not letter n=2. Do not launch 128. | [`2026-09-21_t2v_coinc8_spec.md`](paper_tables/2026-09-21_t2v_coinc8_spec.md). |
| `t2v_moviegen_coinc_8v` | Six arms above. MovieGen first-8, 30 s. | **NOT LAUNCHED.** Code on `run_t2v_chunked.py` + `coincidence_fastweight.py`. Cluster `wan_experiment/results/t2v_moviegen_coinc_8v/`. | Spec above. Harvest: `wan_experiment/scripts/harvest_t2v_coinc.py`. |
