...
| BOND + vanilla DMD on Best-of-N | Is winner-only teacher-matching enough? | Probably not (reverse-KL collapse). Exact video experiment not found. Own the judge + Jeffreys analog + iterative Best-of-2. | [`2026-09-08_bond_dmd_bon_open.md`](paper_tables/2026-09-08_bond_dmd_bon_open.md). |
| Winners / losers / energy well | Negatives + constrain where low energy sits. | Teacher-match winners only. Losers raise energy. Well must be “same scene and living,” not any small blob. | [`2026-09-08_winner_loser_energy.md`](paper_tables/2026-09-08_winner_loser_energy.md). |
| Streaming / continual-learning novel methods | Fill the PI briefing blank. No GPU. | Field streaming = T2V self-rollout. Unused signal = growing real leftover. Rank-1 reality-ranked amortize; rank-2 scene-well energy. | [`2026-09-18_streaming_cl_novel.md`](paper_tables/2026-09-18_streaming_cl_novel.md). |
| Fast / slow streaming reviewer pass | Is (b) delta-memory + evict-after-slow a title? No GPU. | Not as stated. ARL² / TTT-Video / EMA-sink occupy. Slow step cannot sit in 17–23 FPS. | [`2026-09-20_fast_slow_streaming_review.md`](paper_tables/2026-09-20_fast_slow_streaming_review.md). |
| Streaming × CL field buckets | Challenges, failures, approaches. No GPU. | Two fields, 11 challenge buckets, failure modes, approach→fight map. Keep the policy not the name stack. | [`2026-09-20_streaming_cl_field_buckets.md`](paper_tables/2026-09-20_streaming_cl_field_buckets.md). |
| Slow object: DMD sleep vs scene well | Elaboration of the paper-type fork. No GPU. | Train-time teacher-DMD = student. Tiny well bank = frozen generator. Test-time DMD is not streaming. | [`2026-09-20_slow_object_dmd_vs_well.md`](paper_tables/2026-09-20_slow_object_dmd_vs_well.md). |
| Surprise replay + fast-weight read | Is surprise-weighted replay novel? How does SOTA read fast weights? | Titans/SuRe class. Forcing SOTA reads KV+sink. ARL²/TTT-Video already read a fast state at emit. | [`2026-09-20_surprise_replay_and_fastweight_read.md`](paper_tables/2026-09-20_surprise_replay_and_fastweight_read.md). |
| GT stream vs no-GT assessment | Incoming leftover vs pure no-GT streaming. | Hybrid = live prefix + imagined horizon. 30 s is their yardstick, not a GT delay. | [`2026-09-20_gt_stream_vs_nagt_assessment.md`](paper_tables/2026-09-20_gt_stream_vs_nagt_assessment.md). |
| Field gaps + settings | Real 2026 streaming-gen × video-CL gaps. No GPU. | Gap 1 first: named evict blocked until slow object, on caption V2V leftover → 30 s. Replay still a reservoir. ReMind retrieves self, not leftover wells. Dyn lies. | [`2026-09-20_field_gaps_and_settings.md`](paper_tables/2026-09-20_field_gaps_and_settings.md). |
| Leftover scene well method | One method for the four gaps. No GPU. | Frozen leftover well as the streaming anchor. Hits Gaps 1+3+4. Gap 2 (student replay) is a sequel. | [`2026-09-20_leftover_scene_well_method.md`](paper_tables/2026-09-20_leftover_scene_well_method.md). |
| Named evict vs OOD store-cap | Does naming help? Only-store-if-in-support? | Name is bookkeeping unless the well is not an average. Cap generated; leftover extreme opens a new well. | [`2026-09-20_named_evict_and_ood_store.md`](paper_tables/2026-09-20_named_evict_and_ood_store.md). |
| Problem setting LOCKED | Literature-chosen protocol. No GPU tonight. | Caption V2V leftover → 30 s, first-32, leftover-only well, `wan_notta`. Do not reopen. | [`2026-09-20_problem_setting_locked.md`](paper_tables/2026-09-20_problem_setting_locked.md). |
| T2V compare vs success odds | Would T2V make comparison easier? Will the well work? | T2V eases cite, kills leftover. Low as VBench title; moderate cut-hygiene if \(t\) grows. | [`2026-09-20_t2v_compare_and_success.md`](paper_tables/2026-09-20_t2v_compare_and_success.md). |
| V2V vs T2V not principal | First generated chunk vs context frames. | Analogy accepted. T2V = occupied first-chunk sink (idea 2). Do not switch the run. | [`2026-09-20_t2v_v2v_not_principal.md`](paper_tables/2026-09-20_t2v_v2v_not_principal.md). |
| Banded fast-weight write | Drawing board after sink paper too thin. | User band was never incorporated. Promote mid→mid-high OOD into \(W_{\text{fast}}\); refuse high. T2V legal. | [`2026-09-20_banded_fastweight_write.md`](paper_tables/2026-09-20_banded_fastweight_write.md). |
| Banded FW overlaps | Shared concepts vs published work. | Five overlaps. Difference is shoulder write + tail refuse, not “we have fast weights.” | [`2026-09-20_banded_fw_overlaps.md`](paper_tables/2026-09-20_banded_fw_overlaps.md). |
| Beyond OOD for artifacts | Refuse without dataset divergence. | Promote = residual vs \(W_{\text{fast}}\). Refuse = IQ + flicker/subject vs this opening. | [`2026-09-20_beyond_ood_artifacts.md`](paper_tables/2026-09-20_beyond_ood_artifacts.md). |
| Opening-conditional refuse | General refuse, not a failure checklist. | \(-\log p(\text{chunk}\mid\text{opening})\) via teacher residual; threshold = opening quantile. | [`2026-09-20_opening_conditional_refuse.md`](paper_tables/2026-09-20_opening_conditional_refuse.md). |
| Opening spread match | Discourage stills without official Dyn. | T2V: first chunks = high-spread reference (tail freeze). Match that scale; refuse takeover / twitch. | [`2026-09-20_opening_spread_match.md`](paper_tables/2026-09-20_opening_spread_match.md). |
| Slow stays frozen | Does \(W_{\text{fast}}\) write into the 1.3B? | No at test. KV → gated fast write. Fast weights thrown away after the video. | [`2026-09-20_slow_stays_frozen.md`](paper_tables/2026-09-20_slow_stays_frozen.md). |
| KV cache vs fast weights | How the two stores differ at emit. | KV = full recent tape. Fast weights = gated map; can remain after eviction. | [`2026-09-20_kv_vs_fast_weights.md`](paper_tables/2026-09-20_kv_vs_fast_weights.md). |
| Spread-as-motion novelty | Is cloud scale a new motion metric? | No. FlowMo / AdaIN / frame-Δ occupy the gauge. Keep working the write rule. | [`2026-09-20_spread_motion_novelty.md`](paper_tables/2026-09-20_spread_motion_novelty.md). |
...
| Sponsor summer report | External-company progress note. May–Sep 2026. | Lab-style disclosure: classes + outcomes, no unpublished recipe. Charts in `sponsor_summer_2026_figures/`. | [`2026-09-20_sponsor_summer_report.md`](paper_tables/2026-09-20_sponsor_summer_report.md). |
| Temporal threshold as FW write | Cortical coincidence / dynamic threshold → when \(W_{\text{fast}}\) updates. | Medium. Occupied: FWP = fast synapses. Remaining: window + rise-time θ, not Titans residual. | [`2026-09-21_temporal_threshold_fast_weights.md`](paper_tables/2026-09-21_temporal_threshold_fast_weights.md). |
| Coincidence-gated FW update | Detailed write rule after Irie occupancy check. No GPU. | Event tape, high-pass \(u\), spatial \(C\), Azouz \(\theta\), DeltaNet on \(S\) only, no silence decay, fork on leave-support. | [`2026-09-21_coincidence_fastweight_update.md`](paper_tables/2026-09-21_coincidence_fastweight_update.md). |
| Coincidence write publishability | Top-venue enough if it works? Hostile read. | Medium novelty. Unused Irie §4.2 window. Title only if isolation holds on 128. Not on the sentence alone. | [`2026-09-21_coincidence_publishability.md`](paper_tables/2026-09-21_coincidence_publishability.md). |
| Temporal logic, other uses | Timing rules beyond the W_fast write. No GPU. | Read on stillness; split KV by moving vs still. Evict silence; asynchrony refuse; bind/WTA; confirm on clean; recurrent coincidence for CL. | [`2026-09-21_temporal_logic_other_uses.md`](paper_tables/2026-09-21_temporal_logic_other_uses.md). |
| Coincidence first-8 spec | MovieGen T2V 30 s. `notta` / window / coinc / writeevery / titans / meandelta. | **DONE / NO.** Protocol PASS. coinc IQ 56.29 / subject 0.558 / Dyn 8/8 twitch vs notta 72.96 / 0.897 / 2/8. Do not letter n=2. Do not launch 128. | [`2026-09-21_t2v_coinc8_spec.md`](paper_tables/2026-09-21_t2v_coinc8_spec.md). Quality: [`2026-09-22_t2v_coinc8_quality.md`](paper_tables/2026-09-22_t2v_coinc8_quality.md). |
| `t2v_moviegen_coinc_8v` | Six arms above. MovieGen first-8, 30 s. | **DONE / NO.** 18258206 COMPLETED 0:0. All four FW arms IQ ~56 / Dyn 8/8. Window ≈ notta. titans = writeevery. coinc ≈ meandelta. | Spec: [`2026-09-21_t2v_coinc8_spec.md`](paper_tables/2026-09-21_t2v_coinc8_spec.md). Quality: [`2026-09-22_t2v_coinc8_quality.md`](paper_tables/2026-09-22_t2v_coinc8_quality.md). Do not letter n=2. Do not launch 128. |
| After coinc-8 NO, options | Titans arm ≠ published Titans. Untrained write died. | Stay frozen: timing on KV/read, no DeltaNet. Or train a student (TTT class, 8-GPU). Do not retune the eight. | [`2026-09-22_coinc8_after_no_options.md`](paper_tables/2026-09-22_coinc8_after_no_options.md). |
| Competitor FW train vs test | Titans / TTT-Video / ARL² outer vs inner loop. | Test-time is cheap. Install cost: TTT-Video 12.8k H100-h; ARL² **156 H100-h** on Wan 1.3B. Match ARL² + our write. No GPU until user signs. | [`2026-09-22_competitor_fw_settings.md`](paper_tables/2026-09-22_competitor_fw_settings.md). |
...
| Caption pwarp N=8 spec | Slide `pred` after pass 1. Ordinary extras. SF host. | **DONE / NO.** `sf_pwarp` + `sf_pwarp_live`. Cite caption SF first-8. | Spec: [`2026-09-06_wan_v2v_caption_pwarp_spec.md`](paper_tables/2026-09-06_wan_v2v_caption_pwarp_spec.md). Harvest: [`2026-09-06_wan_v2v_caption_pwarp_harvest.md`](paper_tables/2026-09-06_wan_v2v_caption_pwarp_harvest.md). |
| Three eval tracks | Pan-filter V2V / Wan-extend V2V / MovieGen T2V. | Filter first (no GPU). Login `base` imageio has no ffmpeg — use Self Forcing python. Do not mix jobs. | [`2026-09-06_three_eval_tracks.md`](paper_tables/2026-09-06_three_eval_tracks.md). Crash paste: [`experiment_outputs/2026-09-07.md`](experiment_outputs/2026-09-07.md). |
...
| `wan_teacher_leftover_smoke` | `wan_notta` / always / gated / nwarp / nwarp_live / pwarp / pwarp_live. Leftover Panda n=2. Official teacher, no `self_forcing_dmd.pt`. | **HARVESTED 17135846–853 COMPLETED 0:0.** Protocol PASS. notta IQ **75.60** / 0.968 / Dyn 1/2. nwarp IQ **54.25** Dyn 0/2. pwarp 75.52 Dyn 1/2. | **NO** nwarp/pwarp. Do not letter n=2. [`harvest`](paper_tables/2026-09-07_wan_teacher_smoke_harvest.md). |
| `wan_teacher_moviegen_smoke` | Same 7 methods. MovieGen n=2. Official teacher, 81 frames. | **HARVESTED 17135854–861 COMPLETED 0:0.** Protocol PASS. notta IQ **69.97** / 0.953 / Dyn 2/2. nwarp IQ **51.60** Dyn 0/2. pwarp 69.77 Dyn 2/2. | Same table. Do not launch 128. |
| pwarp amplify? | Teacher slide was a **global crop**, not a pan. | Bigger `step` ≠ more Dyn. Legal try = time ramp \(t \cdot v\). | [`2026-09-07_pwarp_amplify.md`](paper_tables/2026-09-07_pwarp_amplify.md). |
| `wan_teacher_pwarp_amp_smoke` | Leftover n=2. A ramp / B persist / C s2-8 / D early / E mag + lives. Official teacher. | **DONE / NO 2026-09-08.** 17172470–483 COMPLETED 0:0. Protocol PASS. Cite `wan_notta` IQ **75.60** / Dyn **1/2**. A ramp `dxL=−15` still Dyn 1/2. B persist IQ **38.94**. C/D/E ≈ notta. E skipped 0001. All five **NO**. | Spec: [`2026-09-07_pwarp_amp_spec.md`](paper_tables/2026-09-07_pwarp_amp_spec.md). Harvest: [`2026-09-08_pwarp_amp_harvest.md`](paper_tables/2026-09-08_pwarp_amp_harvest.md). |
...
| `v2v_panda_caption_wanext_8v` | `notta` on Wan-extended first-8 leftovers. | **DONE / NO 2026-09-07.** 17095709–711 COMPLETED 0:0. `caption_json`, dest==sidecar 8/8. IQ **69.22** vs SF 70.62. Subject **0.576** vs 0.658. Dyn **4/8** vs 2/8 (invented pans). | [`2026-09-07_wan_v2v_caption_wanext_harvest.md`](paper_tables/2026-09-07_wan_v2v_caption_wanext_harvest.md). |
| Pwarp failure points | Interpretation gaps vs user’s “move the guess.” | Harvest named F3 (1 cell/strip) + F6 (dust pan). | [`2026-09-06_pwarp_failure_points.md`](paper_tables/2026-09-06_pwarp_failure_points.md). |
| Caption pwarp N=8 queue | `sf_pwarp` / `sf_pwarp_live` smoke + N=8. | **COMPLETED 0:0 2026-09-06.** 17058386–393. | [`experiment_outputs/2026-09-06.md`](experiment_outputs/2026-09-06.md). |
| `v2v_panda_caption_pwarp_8v` | `sf_pwarp` / `sf_pwarp_live`. Caption N=8. Slide `pred` after pass 1. | **DONE / NO 2026-09-06.** 17058386–393 COMPLETED 0:0. 8/8 + `metadata_csv`. | Always IQ **66.81** Dyn 3/8. Extra Dyn = 0007 flicker (eyes). 0006 sailing: quality ok, no extra motion. Both **NO**. [`harvest`](paper_tables/2026-09-06_wan_v2v_caption_pwarp_harvest.md). Eyes: [`2026-09-06_pwarp_eye_notes.md`](paper_tables/2026-09-06_pwarp_eye_notes.md). Rewrite lit: [`2026-09-06_prompt_rewrite_lit.md`](paper_tables/2026-09-06_prompt_rewrite_lit.md). |
