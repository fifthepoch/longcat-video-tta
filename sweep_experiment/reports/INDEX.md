...
| `wan_teacher_leftover_smoke` | `wan_notta` / always / gated / nwarp / nwarp_live / pwarp / pwarp_live. Leftover Panda n=2. Official teacher, no `self_forcing_dmd.pt`. | **FAILED 2:0 17132796–802.** VBench 17132803 CANCELLED. 2–5 min, ~25–34 GB. Need slurm traceback. | Do not resubmit until tail of `wan_teacher_17132796.err`. |
| `wan_teacher_moviegen_smoke` | Same 7 methods. MovieGen n=2. Official teacher, 81 frames. | **FAILED 2:0 17132804–810.** VBench 17132811 CANCELLED. Same wall as leftover — not leftover-only. | Tail `wan_teacher_17132804.err`. Do not launch 128. |
