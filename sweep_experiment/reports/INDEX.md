...
| `v2v_panda_caption_pwarp_8v` | `sf_pwarp` / `sf_pwarp_live`. Caption N=8. Slide `pred` after pass 1. | **DONE / NO 2026-09-06.** 17058386–393 COMPLETED 0:0. 8/8 + `metadata_csv`. | Always IQ **66.81** Dyn 3/8. Extra Dyn = 0007 flicker (eyes). 0006 sailing: quality ok, no extra motion. Both **NO**. [`harvest`](paper_tables/2026-09-06_wan_v2v_caption_pwarp_harvest.md). Eyes: [`2026-09-06_pwarp_eye_notes.md`](paper_tables/2026-09-06_pwarp_eye_notes.md). |
