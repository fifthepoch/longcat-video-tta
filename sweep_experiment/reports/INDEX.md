...
| Track C + first-chunk warp | MovieGen T2V 30 s. notta / always / gated + nwarp/pwarp from chunk-0 flow. | **IN FLIGHT smoke.** 17121785–792. `self_forcing_extended` n=2. Do not launch 128. | Spec: [`2026-09-07_t2v_moviegen_warp_spec.md`](paper_tables/2026-09-07_t2v_moviegen_warp_spec.md). Paste: [`experiment_outputs/2026-09-07.md`](experiment_outputs/2026-09-07.md). |
